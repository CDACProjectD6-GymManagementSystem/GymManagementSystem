...
public class TrainerServiceImpl implements TrainerService {
	...
	public ApiResponse addTrainer(TrainerRequestDto addDto) {
		...
		entity.setRole(UserRole.ROLE_TRAINER);
	...
	public List<TrainerRespDto> getAllTrainers() {
		...
		return trainerDao.findAll().stream().map(t -> modelMapper.map(t, TrainerRespDto.class)).toList();
	}

	@Override
	public ApiResponse deleteTrainer(Long id) {
		Trainer entity = trainerDao.findById(id).orElseThrow(() -> new ResourceNotFoundException("Trainer not found"));

...
const StaffSection = () => {
  ...
  const [form, setForm] = useState({ firstname: "", lastname: "", email: "", mobile: "", expertise: "" });
  ...
  const resetForm = () => setForm({ firstname: "", lastname: "", email: "", mobile: "", expertise: "" });
  ...
  const handleEdit = (i) => {
    setEditing(i);
    setForm({ ...staffList[i], expertise: staffList[i].expertise || "" });
  };
  ...
  return (
    <div className="admin-card">
      ...
      <table className="admin-table">
        <thead>
          <tr>
            <th>First Name</th><th>Last Name</th><th>Email</th><th>Mobile</th>
        ...
        <tbody>
          ...
          {staffList.length === 0 && (
            <tr className="no-data-row">
              <td colSpan={type === "trainer" ? 6 : 5}>No {staffTitle.toLowerCase()}s found.</td>
            </tr>
          )}
        </tbody>
      </table>
